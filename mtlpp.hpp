...
#define MTLPP_CONFIG_USE_AVAILABILITY 0
    ...
    (__has_feature(attribute_availability_with_message) && __clang__ &&        \
     __clang_major__ >= 7)
...
#define MTLPP_DEPRECATED(macIntro, macDep, iosIntro, iosDep)                   \
  CF_DEPRECATED(macIntro, macDep, iosIntro, iosDep)
#define MTLPP_DEPRECATED_MAC(macIntro, macDep)                                 \
  CF_DEPRECATED_MAC(macIntro, macDep)
#define MTLPP_DEPRECATED_IOS(iosIntro, iosDep)                                 \
  CF_DEPRECATED_IOS(iosIntro, iosDep)
#endif
#endif
...
#define MTLPP_IS_AVAILABLE_MAC(mac)                                            \
  (0 __DARWIN_ALIAS_STARTING_MAC___MAC_##mac(|| 1))
#define MTLPP_IS_AVAILABLE_IOS(ios)                                            \
  (0 __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_##ios(|| 1))
#define MTLPP_IS_AVAILABLE(mac, ios)                                           \
  (MTLPP_IS_AVAILABLE_MAC(mac) || MTLPP_IS_AVAILABLE_IOS(ios))
...
enum class ResourceOptions {
  CpuCacheModeDefaultCache = uint32_t(CpuCacheMode::DefaultCache)
                             << ResourceCpuCacheModeShift,
  CpuCacheModeWriteCombined = uint32_t(CpuCacheMode::WriteCombined)
                              << ResourceCpuCacheModeShift,

  StorageModeShared MTLPP_AVAILABLE(10_11, 9_0) = uint32_t(StorageMode::Shared)
                                                  << ResourceStorageModeShift,
  StorageModeManaged MTLPP_AVAILABLE(10_11, NA) = uint32_t(StorageMode::Managed)
                                                  << ResourceStorageModeShift,
  StorageModePrivate MTLPP_AVAILABLE(10_11,
                                     9_0) = uint32_t(StorageMode::Private)
                                            << ResourceStorageModeShift,
  StorageModeMemoryless MTLPP_AVAILABLE(NA, 10_0) =
      uint32_t(StorageMode::Memoryless) << ResourceStorageModeShift,

  HazardTrackingModeUntracked MTLPP_AVAILABLE(NA, 10_0) =
      0x1 << ResourceHazardTrackingModeShift,

  OptionCpuCacheModeDefault = CpuCacheModeDefaultCache,
  OptionCpuCacheModeWriteCombined = CpuCacheModeWriteCombined,
} MTLPP_AVAILABLE(10_11, 8_0);

enum class ResourceUsage { Read = 1 << 0, Write = 1 << 1, Sample = 1 << 2 };
...
public:
  ...
  Texture NewTexture(const TextureDescriptor &descriptor, uint32_t offset,
                     uint32_t bytesPerRow) MTLPP_AVAILABLE_IOS(8_0);
  void AddDebugMarker(const ns::String &marker, const ns::Range &range)
...
namespace mtlpp {
struct Origin {
  inline Origin(uint32_t x, uint32_t y, uint32_t z) : X(x), Y(y), Z(z) {}
...
struct Region {
  ...
  inline Region(uint32_t x, uint32_t y, uint32_t z, uint32_t width,
...
public:
  ...
  static TextureDescriptor Texture2DDescriptor(PixelFormat pixelFormat,
                                               uint32_t width, uint32_t height,
                                               bool mipmapped);
  static TextureDescriptor TextureCubeDescriptor(PixelFormat pixelFormat,
                                                 uint32_t size, bool mipmapped);
...
public:
  ...
  void GetBytes(void *pixelBytes, uint32_t bytesPerRow, uint32_t bytesPerImage,
                const Region &fromRegion, uint32_t mipmapLevel, uint32_t slice);
  void Replace(const Region &region, uint32_t mipmapLevel, uint32_t slice,
               void *pixelBytes, uint32_t bytesPerRow, uint32_t bytesPerImage);
  void GetBytes(void *pixelBytes, uint32_t bytesPerRow,
                const Region &fromRegion, uint32_t mipmapLevel);
  void Replace(const Region &region, uint32_t mipmapLevel, void *pixelBytes,
               uint32_t bytesPerRow);
  Texture NewTextureView(PixelFormat pixelFormat);
  Texture NewTextureView(PixelFormat pixelFormat, TextureType textureType,
...
public:
  ...
  const ns::Array<Attribute> GetStageInputAttributes() const
      MTLPP_AVAILABLE(10_12, 10_0);
  ns::String GetName() const;
  ns::Dictionary<ns::String, FunctionConstant> GetFunctionConstants() const
      MTLPP_AVAILABLE(10_12, 10_0);

  void SetLabel(const ns::String &label) MTLPP_AVAILABLE(10_12, 10_0);

  ArgumentEncoder NewArgumentEncoderWithBufferIndex(int aaplKernelBufferIndex)
...
public:
  ...
  Function NewFunction(const ns::String &functionName,
                       ...
                       ns::Error *error) MTLPP_AVAILABLE(10_12, 10_0);
  void NewFunction(const ns::String &functionName,
                   const FunctionConstantValues &constantValues,
                   std::function<void(const Function &, const ns::Error &)>
                       completionHandler) MTLPP_AVAILABLE(10_12, 10_0);
} MTLPP_AVAILABLE(10_11, 8_0);
} // namespace mtlpp
...
enum class FeatureSet {
  ...
  iOS_GPUFamily3_v1 MTLPP_AVAILABLE_IOS(8_0) = 4,
...
public:
  ...
  SizeAndAlign HeapTextureSizeAndAlign(const TextureDescriptor &desc)
      MTLPP_AVAILABLE(NA, 10_0);
  SizeAndAlign HeapBufferSizeAndAlign(uint32_t length, ResourceOptions options)
      MTLPP_AVAILABLE(NA, 10_0);
  ...
  Buffer NewBuffer(const void *pointer, uint32_t length,
                   ResourceOptions options);
  Buffer
  NewBuffer(void *pointer, uint32_t length, ResourceOptions options,
            std::function<void(void *pointer, uint32_t length)> deallocator);
  IndirectCommandBuffer
  NewIndirectCommandBuffer(const IndirectCommandBufferDescriptor &descriptor,
                           uint32_t maxCommandCount, ResourceOptions options)
      MTLPP_AVAILABLE(NA, 10_14);

  DepthStencilState
  NewDepthStencilState(const DepthStencilDescriptor &descriptor);
  Texture NewTexture(const TextureDescriptor &descriptor);
  //- (id <MTLTexture>)newTextureWithDescriptor:(MTLTextureDescriptor
  //*)descriptor iosurface:(IOSurfaceRef)iosurface plane:(NSUInteger)plane
  ...
  Library NewLibrary(const char *source, const CompileOptions &options,
                     ns::Error *error);
  void NewLibrary(const char *source, const CompileOptions &options,
                  std::function<void(const Library &, const ns::Error &)>
                      completionHandler);
  RenderPipelineState
  NewRenderPipelineState(const RenderPipelineDescriptor &descriptor,
                         ns::Error *error);
  ...
  void NewRenderPipelineState(
      ...
      std::function<void(const RenderPipelineState &,
          ...
          completionHandler);
  ComputePipelineState NewComputePipelineState(const Function &computeFunction,
                                               ns::Error *error);
  ...
  void NewComputePipelineState(
      ...
      std::function<void(const ComputePipelineState &,
                         const ComputePipelineReflection &, const ns::Error &)>
          completionHandler) MTLPP_AVAILABLE(10_11, 9_0);
  Fence NewFence() MTLPP_AVAILABLE(NA, 10_0);
  bool SupportsFeatureSet(FeatureSet featureSet) const;
  bool SupportsTextureSampleCount(uint32_t sampleCount) const
      MTLPP_AVAILABLE(10_11, 9_0);
} MTLPP_AVAILABLE(10_11, 8_0);
} // namespace mtlpp
...
public:
  ...
  void Synchronize(const Texture &texture, uint32_t slice, uint32_t level)
      MTLPP_AVAILABLE_MAC(10_11);
  void Copy(const Texture &sourceTexture, uint32_t sourceSlice,
            uint32_t sourceLevel, const Origin &sourceOrigin,
  ...
  void Copy(const Buffer &sourceBuffer, uint32_t sourceOffset,
  ...
  void Copy(const Texture &sourceTexture, uint32_t sourceSlice,
            uint32_t sourceLevel, const Origin &sourceOrigin,
            const Size &sourceSize, const Buffer &destinationBuffer,
            uint32_t destinationOffset, uint32_t destinationBytesPerRow,
            uint32_t destinationBytesPerImage);
  void Copy(const Texture &sourceTexture, uint32_t sourceSlice,
            uint32_t sourceLevel, const Origin &sourceOrigin,
            const Size &sourceSize, const Buffer &destinationBuffer,
            uint32_t destinationOffset, uint32_t destinationBytesPerRow,
            uint32_t destinationBytesPerImage, BlitOption options);
  void Copy(const Buffer &sourceBuffer, uint32_t soruceOffset,
  ...
  void ResetCommandsInBuffer(const IndirectCommandBuffer& indirectCommandBuffer,const ns::Range& range);
...
public:
  ...
  void PresentAfterMinimumDuration(const Drawable &drawable, double duration)
      MTLPP_AVAILABLE_IOS(10_3);
  void WaitUntilScheduled();
  void WaitUntilCompleted();
  BlitCommandEncoder BlitCommandEncoder();
  RenderCommandEncoder
  RenderCommandEncoder(const RenderPassDescriptor &renderPassDescriptor);
...
public:
  ...
  void SetBufferOffset(uint32_t offset, uint32_t index)
      MTLPP_AVAILABLE(10_11, 8_3);
  void SetBuffers(const Buffer *buffers, const uint32_t *offsets,
  ...
  void SetSamplerState(const SamplerState &sampler, float lodMinClamp,
                       float lodMaxClamp, uint32_t index);
  void SetSamplerStates(const SamplerState *samplers, const float *lodMinClamps,
  ...
  void DispatchThreadgroups(const Size &threadgroupsPerGrid,
                            const Size &threadsPerThreadgroup);
  void
  DispatchThreadgroupsWithIndirectBuffer(const Buffer &indirectBuffer,
...
public:
  ...
  void AddPresentedHandler(std::function<void(const Drawable &)> handler)
      MTLPP_AVAILABLE_IOS(10_3);
} MTLPP_AVAILABLE(10_11, 8_0);
} // namespace mtlpp
...
public:
  ...
  RenderPassAttachmentDescriptor(const ns::Handle &handle)
      : ns::Object(handle) {}
...
public:
  ...
  RenderPassColorAttachmentDescriptor(const ns::Handle &handle)
...
public:
  ...
  RenderPassDepthAttachmentDescriptor(const ns::Handle &handle)
      : RenderPassAttachmentDescriptor(handle) {}

  double GetClearDepth() const;
  MultisampleDepthResolveFilter GetDepthResolveFilter() const
      MTLPP_AVAILABLE_IOS(9_0);

  void SetClearDepth(double clearDepth);
  void SetDepthResolveFilter(MultisampleDepthResolveFilter depthResolveFilter)
      MTLPP_AVAILABLE_IOS(9_0);
} MTLPP_AVAILABLE(10_11, 8_0);
...
public:
  ...
  RenderPassStencilAttachmentDescriptor(const ns::Handle &handle)
      : RenderPassAttachmentDescriptor(handle) {}
...
public:
  ...
  void SetRenderTargetArrayLength(uint32_t renderTargetArrayLength)
      MTLPP_AVAILABLE_MAC(10_11);
} MTLPP_AVAILABLE(10_11, 8_0);
} // namespace mtlpp
...
public:
  ...
  StageInputOutputDescriptor GetStageInputDescriptor() const
      MTLPP_AVAILABLE(10_12, 10_0);
...
public:
  ...
  void SetVertexData(const void *bytes, uint32_t length, uint32_t index)
      MTLPP_AVAILABLE(10_11, 8_3);
  void SetVertexBuffer(const Buffer &buffer, uint32_t offset, uint32_t index);
  void SetVertexBufferOffset(uint32_t offset, uint32_t index)
      MTLPP_AVAILABLE(10_11, 8_3);
  void SetVertexBuffers(const Buffer *buffers, const uint32_t *offsets,
                        const ns::Range &range);
  ...
  void SetVertexSamplerStates(const SamplerState *samplers,
                              const ns::Range &range);
  void SetVertexSamplerState(const SamplerState &sampler, float lodMinClamp,
                             float lodMaxClamp, uint32_t index);
  void SetVertexSamplerStates(const SamplerState *samplers,
  ...
  void SetFragmentBufferOffset(uint32_t offset, uint32_t index)
      MTLPP_AVAILABLE(10_11, 8_3);
  void SetFragmentBuffers(const Buffer *buffers, const uint32_t *offsets,
                          const ns::Range &range);
  ...
  void SetFragmentSamplerStates(const SamplerState *samplers,
                                const ns::Range &range);
  void SetFragmentSamplerState(const SamplerState &sampler, float lodMinClamp,
                               float lodMaxClamp, uint32_t index);
  void SetFragmentSamplerStates(const SamplerState *samplers,
                                const float *lodMinClamps,
                                const float *lodMaxClamps,
  ...
  void SetStencilReferenceValue(uint32_t frontReferenceValue,
                                uint32_t backReferenceValue);
  void SetVisibilityResultMode(VisibilityResultMode mode, uint32_t offset);
  void SetColorStoreAction(StoreAction storeAction,
  ...
  void SetStencilStoreAction(StoreAction storeAction)
      MTLPP_AVAILABLE(10_12, 10_0);
  void Draw(PrimitiveType primitiveType, uint32_t vertexStart,
            uint32_t vertexCount);
  void Draw(PrimitiveType primitiveType, uint32_t vertexStart,
            uint32_t vertexCount, uint32_t instanceCount)
      MTLPP_AVAILABLE(10_11, 9_0);
  void Draw(PrimitiveType primitiveType, uint32_t vertexStart,
            uint32_t vertexCount, uint32_t instanceCount, uint32_t baseInstance)
      MTLPP_AVAILABLE(10_11, 9_0);
  void Draw(PrimitiveType primitiveType, Buffer indirectBuffer,
            uint32_t indirectBufferOffset);
  ...
  void DrawIndexed(PrimitiveType primitiveType, uint32_t indexCount,
      ...
      MTLPP_AVAILABLE(10_11, 9_0);
  void DrawIndexed(PrimitiveType primitiveType, IndexType indexType,
  ...
  void UpdateFence(const Fence &fence, RenderStages afterStages)
      MTLPP_AVAILABLE_IOS(10_0);
  void WaitForFence(const Fence &fence, RenderStages beforeStages)
      MTLPP_AVAILABLE_IOS(10_0);
  void SetTessellationFactorBuffer(const Buffer &buffer, uint32_t offset,
  ...
  void UseResource(const Buffer& buffer,mtlpp::ResourceUsage usage);
  void ExecuteCommandsInBuffer(IndirectCommandBuffer indirectCommandBuffer,const ns::Range& range);
} MTLPP_AVAILABLE(10_11, 8_0);
} // namespace mtlpp
...
public:
  ...
  void SetConstantValue(const void *value, DataType type,
                        const ns::String &name);
  void SetConstantValues(const void *value, DataType type,
                         const ns::Range &range);
...
public:
  ...
  RenderPipelineColorAttachmentDescriptor(const ns::Handle &handle)
      : ns::Object(handle) {}
...
public:
  ...
  PrimitiveTopologyClass GetInputPrimitiveTopology() const
      MTLPP_AVAILABLE_MAC(10_11);
  TessellationPartitionMode GetTessellationPartitionMode() const
      MTLPP_AVAILABLE(10_12, 10_0);
  ...
  TessellationFactorFormat GetTessellationFactorFormat() const
      MTLPP_AVAILABLE(10_12, 10_0);
  TessellationControlPointIndexType GetTessellationControlPointIndexType() const
      MTLPP_AVAILABLE(10_12, 10_0);
  TessellationFactorStepFunction GetTessellationFactorStepFunction() const
      MTLPP_AVAILABLE(10_12, 10_0);
  Winding GetTessellationOutputWindingOrder() const
      MTLPP_AVAILABLE(10_12, 10_0);
  ...
  void
  SetStencilAttachmentPixelFormat(PixelFormat stencilAttachmentPixelFormat);
  ...
  void SetTessellationPartitionMode(
      ...
      MTLPP_AVAILABLE(10_12, 10_0);
  void SetMaxTessellationFactor(uint32_t maxTessellationFactor)
      MTLPP_AVAILABLE(10_12, 10_0);
...
public:
  ...
  void SetBorderColor(SamplerBorderColor borderColor)
      MTLPP_AVAILABLE_MAC(10_12);
...
public:
  ...
  uint32_t GetSize() const;
  IndirectRenderCommand IndirectRenderCommandAt(int commandIndex_) const;
  IndirectComputeCommand IndirectComputeCommandAt(int commandIndex_) const;
